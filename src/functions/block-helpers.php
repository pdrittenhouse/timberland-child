 ...
 * - Child-SPECIFIC blocks (with block.json): Loaded by timberland_child_include_block_php_files() in blocks.php
 */
 ...
 * Only includes blocks with block.json (child-specific blocks)
 */
